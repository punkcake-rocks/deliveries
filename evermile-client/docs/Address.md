...
`func NewAddress(addressLine1 string, city string, postalCode string, type_ AddressType, ) *Address`
...
`func (o *Address) GetGeoLocation() GeoLocation`

GetGeoLocation returns the GeoLocation field if non-nil, zero value otherwise.

### GetGeoLocationOk

`func (o *Address) GetGeoLocationOk() (*GeoLocation, bool)`
...
`func (o *Address) SetGeoLocation(v GeoLocation)`

SetGeoLocation sets GeoLocation field to given value.

### HasGeoLocation

`func (o *Address) HasGeoLocation() bool`
...
`func (o *Address) GetTypeOk() (*AddressType, bool)`
...
`func (o *Address) SetType(v AddressType)`
