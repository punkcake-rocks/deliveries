...
// checks if the LocationWeeklySchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocationWeeklySchedule{}

// LocationWeeklySchedule A weekly schedule for a location opening hours
type LocationWeeklySchedule struct {
...
func (o *LocationWeeklySchedule) GetThursday() LocationTimeWindow {
...
func (o LocationWeeklySchedule) MarshalJSON() ([]byte, error) {
...
func (o LocationWeeklySchedule) ToMap() (map[string]interface{}, error) {
...
type NullableLocationWeeklySchedule struct {
	value *LocationWeeklySchedule
	isSet bool
}

func (v NullableLocationWeeklySchedule) Get() *LocationWeeklySchedule {
	return v.value
}

func (v *NullableLocationWeeklySchedule) Set(val *LocationWeeklySchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableLocationWeeklySchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableLocationWeeklySchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocationWeeklySchedule(val *LocationWeeklySchedule) *NullableLocationWeeklySchedule {
	return &NullableLocationWeeklySchedule{value: val, isSet: true}
}

func (v NullableLocationWeeklySchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocationWeeklySchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
